...
<div class="<?php print $classes; ?>"<?php print $attributes; ?>>
    ...
    <div class="field-items"<?php print $content_attributes; ?>>
        ...
        <div class="email-wrapper">
            <div id="tooltip-control" class="field-item <?php print $delta % 2 ? 'odd' : 'even'; ?>"<?php print $item_attributes[$delta]; ?>>
                <?php print render($item); ?>
            </div>
            <span id="tooltip-target" class="email-tooltip"><?php print $item['#markup']; ?></span>
        </div>
        <?php endforeach; ?>
    </div>
</div>
