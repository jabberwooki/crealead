...
<<?php print $layout_wrapper; print $layout_attributes; ?> class="<?php print $classes; ?>">
  ...
  <?php if ($top): ?>
    <div class="row">
      ...
      <a class="button-back float-right" style="position: relative; top: 30px;" href="/reunions-information">Retour sur la page de descriptif des réunions d'information</a>
        <?php print $top; ?>
