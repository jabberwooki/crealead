        ...
        <?php foreach ($items as $delta => $item): ?>
            ...
            switch ($index) {
                case 0 :
                  ...
                  // on insère un div séparateur pour bien passer la (3xn)+ 1 colonne à la ligne et éviter ceci :
                  //
                  //   --------------------    --------------------    --------------------
                  //  |                    |  |                    |  |                    |
                  //  |                    |  |                    |  |                    |
                  ...
                  //                                                   --------------------
                  //
                  // Visible seulement pour les affichage medium (>= 992px) et large (>=1200px).
