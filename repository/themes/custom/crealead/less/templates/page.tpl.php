                  ...
                  <a class="logo navbar-btn pull-left"
                     href="<?php print $front_page; ?>">
                      <img src="<?php print $logo; ?>"
                           alt="Crealead : Coopérative d'entrepreneurs à Montpellier"/>
                  </a>
              </h1>
          <?php endif; ?>
...
<?php if (!empty($page['sector_brands_header'])): ?>
    ...
    <div id="introduction"
         class="sector-brands-header bg-gray-crealead-icons <?php if ($logged_in) echo 'container-header-logged-in' ?>">
        <div class="container">
            <div class="row">
...
<?php if (!empty($page['content_header'])): ?>
    <div class="content-header bg-gray-crealead-icons <?php if ($logged_in) {
      echo 'container-header-logged-in';
    }
    if (!empty($page['full_content_header'])) {
      echo ' container-header-second';
    } ?>">
        <div class="container">
            <div class="row">
